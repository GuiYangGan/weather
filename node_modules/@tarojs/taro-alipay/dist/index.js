...
function componentTrigger(component, key, args) {
    ...
    if (component['$$refs'] && component['$$refs'].length > 0) {
      ...
      component['$$refs'].forEach(function (ref) {
        ...
        if (ref.type === 'component') {
          var _childs = component.$scope._childs || {};
  ...
  if (key === 'componentWillUnmount') {
    ...
    if (component.$componentType === 'COMPONENT' && typeof scope.props[COLLECT_CHILDS] === 'function' && typeof scope.props.id === 'string') {
    ...
    if (component.__mounted) {
      if (component['$$refs'] && component['$$refs'].length > 0) {
        component['$$refs'].forEach(function (ref) {
          ...
          var target = _childs[ref.id] || null;
...
function () {
  ...
  _createClass(BaseComponent, [{
    ...
    value: function _init(scope) {
      ...
      if (scope.$component.$componentType === 'COMPONENT' && typeof scope.props[COLLECT_CHILDS$1] === 'function' && typeof scope.props.id === 'string') {
        scope.props[COLLECT_CHILDS$1](scope.$component, scope.props.id);
      }
    }
  }, {
    key: "setState",
