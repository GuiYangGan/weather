...
function weixinCorpSupport(apiName) {
  return function () {
    return console.error("h5\u7AEF\u4EC5\u5728\u5FAE\u4FE1\u516C\u4F17\u53F7\u4E2D\u652F\u6301 API ".concat(apiName));
  };
}
...
var chooseLocation = temporarilyNotSupport('chooseLocation'); // export const openLocation = temporarilyNotSupport('openLocation')
// 设备
  ...
  return function (options) {
    ...
    if (typeof options === 'string') {
      if (args.length) {
        ...
        return (_wx = wx)[apiName].apply(_wx, [options].concat(args));
      }
    ...
    var p = new Promise(function (resolve, reject) {
      ...
      if (args.length) {
        ...
        task = (_wx2 = wx)[apiName].apply(_wx2, [obj].concat(args));
      } else {
        task = wx[apiName](obj);
      }
    });
...
var scanCode = processApis('scanQRCode', {
  needResult: 1
});
var getLocation = processApis('getLocation');
var openLocation = processApis('openLocation', {
  scale: 18
});
...
var onPullDownRefresh = function onPullDownRefresh(opt) {};
